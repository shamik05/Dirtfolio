const projectsList = [
  {
    name: "Balls of War",
    id: "bow",
    description: "The two player card game War with an NBA twist and mechanics!",
  ...
  },
  {
    ...
    id: "wgw",
    description: "Your one stop for everything bike. An e-commerce website with user account and order functionality!",
